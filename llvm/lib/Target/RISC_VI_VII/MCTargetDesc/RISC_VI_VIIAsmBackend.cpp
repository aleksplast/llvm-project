...
namespace {
class RISC_VI_VIIAsmBackend : public MCAsmBackend {
protected:
...
class ELFRISC_VI_VIIAsmBackend : public RISC_VI_VIIAsmBackend {
  Triple::OSType OSType;

public:
  ELFRISC_VI_VIIAsmBackend(const Target &T, Triple::OSType OSType)
      : RISC_VI_VIIAsmBackend(T), OSType(OSType) {}
  ...
  createObjectTargetWriter() const override {
    ...
    return createRISC_VI_VIIELFObjectWriter(false, OSABI);
  }
};

} // end anonymous namespace

MCAsmBackend *llvm::createRISC_VI_VIIAsmBackend(const Target &T,
                                        const MCSubtargetInfo &STI,
                                        const MCRegisterInfo &MRI,
                                        const MCTargetOptions &Options) {
  return new ELFRISC_VI_VIIAsmBackend(T, STI.getTargetTriple().getOS());
}
